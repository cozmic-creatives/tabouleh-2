...
const Index = () => {
  ...
  const homeSchema = {
    ...
    specialties: [
      "Syrische keuken",
      "Halal gerechten",
      "Midden-Oosterse specialiteiten",
    ],
    hasMenu: {
      "@type": "Menu",
        ...
        <section className="py-16 bg-spice-600 text-white text-center">
          <div className="container mx-auto">
            ...
            <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
              Geniet van authentieke Midden-Oost keuken bij TABOULEH 2.
              Beschikbaar voor afhalen of dineer ter plaatse!
            </p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <OrderButton
                size="lg"
                className="bg-white hover:bg-gray-100 text-spice-600"
                text="Plaats je Bestelling"
              />
              <div className="text-white font-bold">
                of bel +32 466 20 67 78
              </div>
            </div>
          </div>
        </section>
