...
import TaboulehLogo from "@/components/TaboulehLogo";
      ...
      <div className="container mx-auto flex items-center justify-between h-16">
        <Link to="/" className="flex items-center gap-2">
          ...
          <div className="flex items-center">
            <span className="text-2xl font-serif font-bold text-spice-600">
              TABOULEH 2
            </span>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link
            to="/"
            className="text-gray-700 hover:text-spice-600 font-medium transition-colors"
          >
            Home
          </Link>
          <Link
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-b border-clay-200 py-4 px-4 animate-fade-in">
          <nav className="flex flex-col space-y-4">
            ...
            <Button
              asChild
              className="bg-spice-600 hover:bg-spice-700 w-full mt-4"
            >
