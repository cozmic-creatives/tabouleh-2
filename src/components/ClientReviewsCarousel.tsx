...
const reviews: Review[] = [
  ...
  },
  {
    ...
    initials: "XO",
    content:
      "Heelijk, super schoon, vriendelijkeheid en de service was top 10/10.",
    rating: 5,
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative w-full overflow-hidden mb-6">
        ...
        >
          ...
          <div className="hidden md:block">
            <CarouselPrevious className="left-2 bg-white text-black/60 border-black/30 z-20 shadow-lg" />
            <CarouselNext className="right-2 bg-white text-black/60 border-black/30 z-20 shadow-lg" />
          </div>
        </Carousel>
      ...
      >
        <Button
          variant="outline"
          className="border-spice-200 text-spice-700 hover:bg-spice-50"
        >
